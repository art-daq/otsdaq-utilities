#ifndef _ots_RunDbViewer_version_h_
#define _ots_RunDbViewer_version_h_
...
namespace RunDbViewer
{
const std::string project  = "otsdaq";
const std::string package  = "RunDbViewer";
const std::string versions = MYPACKAGE_FULL_VERSION_LIST;
const std::string summary  = "The RunDbViewer Supervisor";
const std::string description =
    "The RunDbViewer Supervisor handles rundbviewer messages from the system and users as well "
