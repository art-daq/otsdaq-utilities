...
const ECLEntry_t::subject_optional& ECLEntry_t::subject() const { return this->subject_; }

ECLEntry_t::subject_optional& ECLEntry_t::subject() { return this->subject_; }

void ECLEntry_t::subject(const subject_type& x) { this->subject_.set(x); }

void ECLEntry_t::subject(const subject_optional& x) { this->subject_ = x; }

void ECLEntry_t::subject(::std::unique_ptr<subject_type> x)
{
...
void operator<<(::xercesc::DOMElement& e, const ECLEntry_t& i)
{
	...
	if(i.subject())
	{
		::xercesc::DOMAttr& a(::xsd::cxx::xml::dom::create_attribute("subject", e));
