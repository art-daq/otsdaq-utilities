import { settings, internals, browser, gStyle, isObject, isFunc, isStr, clTGaxis, nsSVG, kInspect, getDocument } from '../core.js';
import { rgb as d3_rgb, select as d3_select } from '../d3.js';
import { selectgStyle, saveSettings, readSettings, saveStyle, getColorExec, changeObjectMember } from './utils.js';
import { getColor } from '../base/colors.js';
import { TAttMarkerHandler } from '../base/TAttMarkerHandler.js';
import { getSvgLineStyle } from '../base/TAttLineHandler.js';
import { TAttFillHandler } from '../base/TAttFillHandler.js';
import { FontHandler, kArial } from '../base/FontHandler.js';
import { kAxisLabels } from '../base/ObjectPainter.js';
...
/** @summary Create JSROOT menu
  ...
  * @example
  * import { createMenu } from 'https://root.cern/js/latest/modules/gui/menu.js';
