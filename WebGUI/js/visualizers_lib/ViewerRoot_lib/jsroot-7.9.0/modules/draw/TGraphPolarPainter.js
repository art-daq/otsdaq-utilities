import { settings, gStyle, create, BIT, clTPaveText, kTitle } from '../core.js';
import { scaleLinear, pointer as d3_pointer } from '../d3.js';
import { DrawOptions, buildSvgCurve, makeTranslate } from '../base/BasePainter.js';
import { ObjectPainter, getElementMainPainter } from '../base/ObjectPainter.js';
import { TPavePainter, kPosTitle } from '../hist/TPavePainter.js';
import { ensureTCanvas } from '../gpad/TCanvasPainter.js';
import { TooltipHandler } from '../gpad/TFramePainter.js';
