import { gStyle, isStr, kNoZoom, kInspect } from '../core.js';
import { rgb as d3_rgb } from '../d3.js';
import { floatToString, TRandom, addHighlightStyle } from '../base/BasePainter.js';
import { RHistPainter } from './RHistPainter.js';
import { ensureRCanvas } from '../gpad/RCanvasPainter.js';
import { buildHist2dContour } from '../hist2d/TH2Painter.js';
...
class RH2Painter extends RHistPainter {
   ...
   /** @summary Performs 3D drawing of histogram
     * @return {Promise} when ready */
   async draw3D(reason) {
      console.log('3D drawing is disabled, load ./hist/RH1Painter.js');
