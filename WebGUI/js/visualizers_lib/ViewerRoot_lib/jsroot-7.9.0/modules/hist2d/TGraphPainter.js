import { gStyle, BIT, settings, create, createHistogram, setHistogramTitle, isFunc, isStr,
         clTPaveStats, clTCutG, clTH1F, clTH2F, clTF1, clTF2, clTPad, kNoZoom, kNoStats } from '../core.js';
import { select as d3_select } from '../d3.js';
import { DrawOptions, buildSvgCurve, makeTranslate, addHighlightStyle } from '../base/BasePainter.js';
import { ObjectPainter, kAxisNormal } from '../base/ObjectPainter.js';
import { FunctionsHandler } from './THistPainter.js';
import { TH1Painter, PadDrawOptions } from './TH1Painter.js';
import { kBlack, kWhite } from '../base/colors.js';
import { addMoveHandler } from '../gui/utils.js';
import { assignContextMenu, kNoReorder } from '../gui/menu.js';
...
class TGraphPainter extends ObjectPainter {
   ...
   drawBins3D(/* fp, graph */) {
      console.log('Load ./hist/TGraphPainter.js to draw graph in 3D');
   }
