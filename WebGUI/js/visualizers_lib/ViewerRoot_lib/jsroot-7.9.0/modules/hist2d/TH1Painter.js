import { gStyle, settings, clTF1, clTProfile, kNoZoom, kInspect, isFunc } from '../core.js';
import { rgb as d3_rgb } from '../d3.js';
import { floatToString, buildSvgCurve, addHighlightStyle } from '../base/BasePainter.js';
import { THistPainter } from './THistPainter.js';
import { getTF1Value } from '../base/func.js';
...
class TH1Painter extends THistPainter {
   ...
   /** @summary Should performs 3D drawing of histogram
     ...
     * @return {Promise} when ready */
   async draw3D(reason) {
      console.log('3D drawing is disabled, load ./hist/TH1Painter.js');
