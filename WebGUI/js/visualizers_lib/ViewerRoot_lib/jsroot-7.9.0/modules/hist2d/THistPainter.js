import { gStyle, BIT, settings, constants, create, isObject, isFunc, isStr, getPromise,
         ...
         clTAxis, clTF1, clTF2, kNoZoom, clTCutG, kNoStats, kTitle, setHistogramTitle } from '../core.js';
import { getColor, getColorPalette } from '../base/colors.js';
import { DrawOptions } from '../base/BasePainter.js';
import { ObjectPainter, EAxisBits, kAxisTime, kAxisLabels } from '../base/ObjectPainter.js';
import { TPavePainter, kPosTitle } from '../hist/TPavePainter.js';
import { ensureTCanvas } from '../gpad/TCanvasPainter.js';
import { gamma_quantile, gamma_quantile_c } from '../base/math.js';
