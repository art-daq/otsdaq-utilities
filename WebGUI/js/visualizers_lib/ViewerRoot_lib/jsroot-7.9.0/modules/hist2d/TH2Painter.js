import { gStyle, settings, createHistogram, createTPolyLine, isFunc, isStr,
         clTMultiGraph, clTH1D, clTF2, clTProfile2D, kInspect } from '../core.js';
import { pointer as d3_pointer, rgb as d3_rgb, chord as d3_chord, arc as d3_arc, ribbon as d3_ribbon } from '../d3.js';
import { kBlack } from '../base/colors.js';
import { TRandom, floatToString, makeTranslate, addHighlightStyle, getBoxDecorations } from '../base/BasePainter.js';
import { EAxisBits } from '../base/ObjectPainter.js';
import { THistPainter, kPOLAR } from './THistPainter.js';
import { assignContextMenu } from '../gui/menu.js';
...
class TH2Painter extends THistPainter {
   ...
   /** @summary Should performs 3D drawing of histogram
     ...
     * @return {Promise} when ready */
   async draw3D(reason) {
      console.log('3D drawing is disabled, load ./hist/TH2Painter.js');
