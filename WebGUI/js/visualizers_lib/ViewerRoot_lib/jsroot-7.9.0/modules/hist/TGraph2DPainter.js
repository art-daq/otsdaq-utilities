import { settings, createHistogram, setHistogramTitle, kNoZoom,
         clTH2D, clTGraph2DErrors, clTGraph2DAsymmErrors, clTPaletteAxis, kNoStats } from '../core.js';
import { buildSvgCurve, DrawOptions } from '../base/BasePainter.js';
import { ObjectPainter } from '../base/ObjectPainter.js';
import { TH2Painter } from './TH2Painter.js';
import { Triangles3DHandler } from '../hist2d/TH2Painter.js';
import { createLineSegments, PointsCreator, getMaterialArgs, THREE } from '../base/base3d.js';
import { convertLegoBuf, createLegoGeom } from './hist3d.js';
