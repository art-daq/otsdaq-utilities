import { gStyle, browser, settings, clone, isObject, isFunc, isStr, BIT,
         ...
         clTText, clTLatex, clTLine, clTBox, kTitle, isNodeJs, nsSVG } from '../core.js';
import { select as d3_select, rgb as d3_rgb, pointer as d3_pointer } from '../d3.js';
import { Prob } from '../base/math.js';
import { floatToString, makeTranslate, compressSVG, svgToImage, addHighlightStyle } from '../base/BasePainter.js';
import { ObjectPainter, EAxisBits } from '../base/ObjectPainter.js';
import { approximateLabelWidth } from '../base/latex.js';
import { showPainterMenu } from '../gui/menu.js';
import { getColorExec } from '../gui/utils.js';
import { TAxisPainter } from '../gpad/TAxisPainter.js';
import { addDragHandler } from '../gpad/TFramePainter.js';
