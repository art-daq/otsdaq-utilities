import { decodeUrl, settings, constants, gStyle, internals, browser,
         findFunction, parse, isFunc, isStr, isObject, isBatchMode, setBatchMode } from './core.js';
import { select as d3_select } from './d3.js';
import { HierarchyPainter } from './gui/HierarchyPainter.js';
import { setStoragePrefix, readSettings, readStyle } from './gui/utils.js';
import { setDefaultDrawOpt } from './draw.js';
...
/** @summary Build main GUI
  ...
  * @example
  * import { buildGUI } from 'https://root.cern/js/latest/modules/gui.js';
  * buildGUI('guiDiv'); */
