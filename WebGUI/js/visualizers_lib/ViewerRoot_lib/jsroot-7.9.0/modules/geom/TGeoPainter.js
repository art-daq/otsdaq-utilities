import { httpRequest, browser, source_dir, settings, internals, constants, create, clone,
         ...
         clTGeoVolume, clTGeoNode, clTGeoNodeMatrix, nsREX, nsSVG, kInspect } from '../core.js';
import { showProgress, injectStyle, ToolbarIcons } from '../gui/utils.js';
import { GUI } from '../gui/lil-gui.js';
import { THREE, assign3DHandler, disposeThreejsObject, createOrbitControl,
         ...
         createTextGeometry } from '../base/base3d.js';
import { getColor, getRootColors } from '../base/colors.js';
import { DrawOptions } from '../base/BasePainter.js';
import { ObjectPainter } from '../base/ObjectPainter.js';
import { createMenu, closeMenu } from '../gui/menu.js';
import { TAxisPainter } from '../gpad/TAxisPainter.js';
import { ensureTCanvas } from '../gpad/TCanvasPainter.js';
import { kindGeo, kindEve,
         ...
         getBoundingBox, provideObjectInfo, isSameStack, checkDuplicates, getObjectName, cleanupShape, getShapeIcon } from './geobase.js';
...
/** @summary Build three.js model for given geometry object
  ...
  * @example
  * import { build } from 'https://root.cern/js/latest/modules/geom/TGeoPainter.js';
  * let obj3d = build(obj);
