import { select as d3_select, pointer as d3_pointer } from '../d3.js';
import { settings, constants, internals, isNodeJs, isBatchMode, getPromise, BIT,
         prROOT, clTObjString, clTAxis, isObject, isFunc, isStr, getDocument, urlClassPrefix } from '../core.js';
import { isPlainText, producePlainText, produceLatex, produceMathjax, typesetMathjax, approximateLabelWidth } from './latex.js';
import { getElementRect, BasePainter, makeTranslate } from './BasePainter.js';
import { TAttMarkerHandler } from './TAttMarkerHandler.js';
import { TAttFillHandler } from './TAttFillHandler.js';
import { TAttLineHandler } from './TAttLineHandler.js';
import { TAttTextHandler } from './TAttTextHandler.js';
import { FontHandler } from './FontHandler.js';
import { getRootColors } from './colors.js';
...
class ObjectPainter extends BasePainter {
   ...
   /** @summary Returns array with supported draw options as configured in draw.js
...
/** @summary Check resize of drawn element
  ...
  * @example
  * import { resize } from 'https://root.cern/js/latest/modules/base/ObjectPainter.js';
...
/** @summary Safely remove all drawings from specified element
  ...
  * @public
  * @example
  * import { cleanup } from 'https://root.cern/js/latest/modules/base/ObjectPainter.js';
  * cleanup('drawing');
