...
if (_src_dir[0] !== '$')
   ...
   let pos = _src.indexOf('modules/core.js');
   if (pos < 0)
...
/** @summary Method converts JavaScript object into ROOT-like JSON
  ...
  * @example
  * import { openFile, draw, toJSON } from 'https://root.cern/js/latest/modules/main.js';
...
/** @summary decodes URL options after '?' mark
  ...
  * @example
  * import { decodeUrl } from 'https://root.cern/js/latest/modules/core.js';
...
/** @summary Submit asynchronous http request
  ...
  * @example
  * import { httpRequest } from 'https://root.cern/js/latest/modules/core.js';
...
/** @summary Create some ROOT classes
  ...
  * @example
  * import { create } from 'https://root.cern/js/latest/modules/core.js';
...
/** @summary Create histogram object of specified type
  ...
  * @example
  * import { createHistogram } from 'https://root.cern/js/latest/modules/core.js';
...
/** @summary Creates THStack object
  ...
  * @example
  * import { createHistogram, createTHStack } from 'https://root.cern/js/latest/modules/core.js';
  * let nbinsx = 20;
...
/** @summary Creates TMultiGraph object
  ...
  * @example
  * import { createTGraph, createTMultiGraph } from 'https://root.cern/js/latest/modules/core.js';
