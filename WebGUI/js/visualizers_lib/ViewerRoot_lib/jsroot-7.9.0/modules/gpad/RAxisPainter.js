import { select as d3_select, pointer as d3_pointer,
         ...
         scaleLog as d3_scaleLog, scaleLinear as d3_scaleLinear } from '../d3.js';
import { settings, isFunc, urlClassPrefix } from '../core.js';
import { makeTranslate, addHighlightStyle } from '../base/BasePainter.js';
import { AxisPainterMethods, chooseTimeFormat } from './TAxisPainter.js';
import { createMenu } from '../gui/menu.js';
import { addDragHandler } from './TFramePainter.js';
import { kAxisLabels, kAxisNormal, kAxisTime } from '../base/ObjectPainter.js';
