import { gStyle, settings, browser, constants, internals, addMethods, isPromise, getPromise, postponePromise,
         isBatchMode, isObject, isFunc, isStr, clTPad, clTFrame, nsREX, nsSVG, urlClassPrefix } from '../core.js';
import { ColorPalette, addColor, getRootColors, convertColor } from '../base/colors.js';
import { RObjectPainter } from '../base/RObjectPainter.js';
import { prSVG, getElementRect, getAbsPosInCanvas, DrawOptions, compressSVG, makeTranslate, svgToImage } from '../base/BasePainter.js';
import { selectActivePad, getActivePad } from '../base/ObjectPainter.js';
import { registerForResize, saveFile } from '../gui/utils.js';
import { BrowserLayout, getHPainter } from '../gui/display.js';
import { createMenu, closeMenu } from '../gui/menu.js';
import { PadButtonsHandler, webSnapIds } from './TPadPainter.js';
