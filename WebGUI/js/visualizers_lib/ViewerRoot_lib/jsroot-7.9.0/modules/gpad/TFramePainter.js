import { gStyle, settings, internals, isFunc, isStr, postponePromise, browser,
         clTAxis, clTFrame, kNoZoom, urlClassPrefix } from '../core.js';
import { select as d3_select, pointer as d3_pointer,
         pointers as d3_pointers, drag as d3_drag, rgb as d3_rgb } from '../d3.js';
import { getElementRect, getAbsPosInCanvas, makeTranslate, addHighlightStyle, getBoxDecorations } from '../base/BasePainter.js';
import { getActivePad, ObjectPainter, EAxisBits, kAxisLabels } from '../base/ObjectPainter.js';
import { getSvgLineStyle } from '../base/TAttLineHandler.js';
import { TAxisPainter } from './TAxisPainter.js';
import { FontHandler } from '../base/FontHandler.js';
import { createMenu, closeMenu, showPainterMenu, hasMenu } from '../gui/menu.js';
import { detectRightButton } from '../gui/utils.js';
