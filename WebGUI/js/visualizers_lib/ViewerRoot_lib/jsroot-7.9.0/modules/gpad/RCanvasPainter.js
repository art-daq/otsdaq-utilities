import { settings, create, parse, toJSON, loadScript, registerMethods, isBatchMode, isFunc, isStr, nsREX } from '../core.js';
import { select as d3_select, rgb as d3_rgb } from '../d3.js';
import { closeCurrentWindow, showProgress, loadOpenui5, ToolbarIcons, getColorExec } from '../gui/utils.js';
import { GridDisplay, getHPainter } from '../gui/display.js';
import { makeTranslate } from '../base/BasePainter.js';
import { convertColor } from '../base/colors.js';
import { selectActivePad, cleanup, resize, EAxisBits } from '../base/ObjectPainter.js';
import { RObjectPainter } from '../base/RObjectPainter.js';
import { RAxisPainter } from './RAxisPainter.js';
import { RFramePainter } from './RFramePainter.js';
import { RPadPainter } from './RPadPainter.js';
