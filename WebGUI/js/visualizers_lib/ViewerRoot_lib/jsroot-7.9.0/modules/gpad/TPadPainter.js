import { gStyle, settings, constants, browser, internals, BIT,
         ...
         clTHStack, clTMultiGraph, clTLegendEntry, nsSVG, kTitle, clTList, urlClassPrefix } from '../core.js';
import { select as d3_select, rgb as d3_rgb } from '../d3.js';
import { ColorPalette, adoptRootColors, getColorPalette, getGrayColors, extendRootColors,
         getRGBfromTColor, decodeWebCanvasColors } from '../base/colors.js';
import { prSVG, prJSON, getElementRect, getAbsPosInCanvas, DrawOptions, compressSVG, makeTranslate,
         getTDatime, convertDate, svgToImage, getBoxDecorations } from '../base/BasePainter.js';
import { ObjectPainter, selectActivePad, getActivePad } from '../base/ObjectPainter.js';
import { TAttLineHandler } from '../base/TAttLineHandler.js';
import { addCustomFont } from '../base/FontHandler.js';
import { addDragHandler } from './TFramePainter.js';
import { createMenu, closeMenu } from '../gui/menu.js';
import { ToolbarIcons, registerForResize, saveFile } from '../gui/utils.js';
import { BrowserLayout, getHPainter } from '../gui/display.js';
...
class TPadPainter extends ObjectPainter {
  ...
  /** @summary returns custom palette associated with pad or top canvas
   ...
   async drawObject(/* dom, obj, opt */) {
      console.log('Not possible to draw object without loading of draw.js');
      return null;
   }
   ...
   async buildLegend(x1, y1, x2, y2, title, opt) {
      ...
      if (!lp && !isFunc(this.drawObject))
         return Promise.reject(Error('Not possible to build legend while module draw.js was not load'));
   ...
   /** @summary Save pad as image
     ...
     * @example
     * import { getElementCanvPainter } from 'https://root.cern/js/latest/modules/base/ObjectPainter.js';
