...
const ignore_jsroot_modules = [ './base/lzma.js', './base/zstd.js', './base/zstd.js' ];
...
const config_2d = {
  ...config,
  input: "modules/hist2d/bundle.js",
  output: {
    ...config.output,
...
const config_geom_nothreejs = {
  ...
  plugins: [
    modify({
      "from '../three.js'": "from 'three'",
      "from '../three_addons.js'": "from 'three/addons'"
    }),
    ignore(ignore_modules),
    nodeResolve(),
    json(),
