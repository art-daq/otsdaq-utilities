...
19. Support injection of ES6 modules via '&inject=path.js'
...
16. Split extras into three_addons.js, provide jsroot geometry build without three.js
...
3. Fix several bugs in `csg.js`, improve geometry clipping
...
3. Fix - tree_draw.js example, export treeDraw function from main.js
