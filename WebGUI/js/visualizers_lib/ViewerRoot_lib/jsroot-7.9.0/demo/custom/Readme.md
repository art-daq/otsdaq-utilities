...
In case of such simple class one can use `&inject=<path_to_javascript_module.js>` URL parameter
...
In the demo relative path to JSROOT modules/core.js is specified. One also can provide full path to such module.
