...
function loadPainter() {
   ...
   return Promise.all([import('../modules/d3.js'), import('../modules/draw.js'), import('../modules/base/colors.js'),
                       import('../modules/base/BasePainter.js'), import('../modules/base/ObjectPainter.js'),
                       import('../modules/base/TAttLineHandler.js'), import('../modules/gui/menu.js')]).then(res => {
      if (jsrp) return jsrp;
...
exports.httpRequest = function(...args) {
   return _sync().then(() => import('../modules/core.js')).then(handle => handle.httpRequest(...args));
}

exports.loadScript = function(...args) {
   return _sync().then(() => import('../modules/core.js')).then(handle => handle.loadScript(...args));
}

exports.buildGUI = function(...args) {
   return _sync().then(() => import('../modules/gui.js')).then(handle => handle.buildGUI(...args));
}

exports.openFile = function(...args) {
   return _sync().then(() => import('../modules/io.js')).then(handle => handle.openFile(...args));
}
...
exports.draw = function(dom, obj, opt) {
   return _sync().then(() => import('../modules/draw.js')).then(handle => handle.draw(dom, test_parse_workaround(obj), opt));
}

exports.redraw = function(dom, obj, opt) {
   return _sync().then(() => import('../modules/draw.js')).then(handle => handle.redraw(dom, test_parse_workaround(obj), opt));
}
...
function v6_require(need) {
   ...
   need.forEach(name => {
      if (name == 'hist')
         arr.push(Promise.all([import('../modules/hist/TH1Painter.js'), import('../modules/hist/TH2Painter.js'), import('../modules/hist/THStackPainter.js')]).then(arr => {
            // copy hist painter objects into JSROOT
            Object.assign(globalThis.JSROOT, arr[0], arr[1], arr[2]);
         }));
      else if (name == 'more')
         arr.push(import('../modules/draw/more.js'));
      else if (name == 'gpad')
         arr.push(loadPainter().then(() => Promise.all([import('../modules/gpad/TAxisPainter.js'), import('../modules/gpad/TPadPainter.js'), import('../modules/gpad/TCanvasPainter.js')])).then(arr => {
            // copy all classes
            Object.assign(globalThis.JSROOT, arr[0], arr[1], arr[2]);
         ...
         arr.push(loadPainter().then(() => Promise.all([import('../modules/gpad/RAxisPainter.js'), import('../modules/gpad/RPadPainter.js'), import('../modules/gpad/RCanvasPainter.js')])).then(arr => {
            // copy all classes
            Object.assign(globalThis.JSROOT, arr[0], arr[1], arr[2]);
         ...
         arr.push(import('../modules/io.js'));
      else if (name == 'tree')
         arr.push(import('../modules/tree.js'));
      else if (name == 'geom')
         arr.push(geo ? Promise.resolve(geo) : loadPainter().then(() => Promise.all([import('../modules/geom/geobase.js'),
            import('../modules/geom/TGeoPainter.js'), import('../modules/base/base3d.js'), import('../modules/three.js'), import('../modules/three_addons.js')])).then(res => {
         ...
         arr.push(import('../modules/base/math.js'));
      else if (name == 'latex')
         arr.push(import('../modules/base/latex.js'));
      else if (name == 'painter')
         arr.push(loadPainter());
      else if (name == 'hierarchy')
         arr.push(Promise.all([import('../modules/gui/display.js'), import('../modules/gui/HierarchyPainter.js'), import('../modules/draw/TTree.js')]).then(arr => {
            Object.assign(globalThis.JSROOT, arr[0], arr[1], arr[2]);
         ...
         arr.push(import('../modules/gui/utils.js').then(handle => handle.loadOpenui5(_openui5args)));
      else if (name == 'interactive')
         arr.push(import('../modules/gui/utils.js').then(handle => { return { addMoveHandler: handle.addMoveHandler }; }));
      else if (name.indexOf('.js') >= 0)
         arr.push(import('../modules/core.js').then(handle => handle.loadScript(name)));
   });
...
exports.connectWebWindow = function(arg) {
   ...
   }).then(() => import('../modules/webwindow.js')).then(h => {
...
if ((typeof globalThis !== 'undefined') && !globalThis.JSROOT) {
   ...
   let pr = Promise.all([import('../modules/core.js'), import('../modules/draw.js'),
            import('../modules/gui/HierarchyPainter.js'), import('../modules/gui/display.js')]).then(arr => {
