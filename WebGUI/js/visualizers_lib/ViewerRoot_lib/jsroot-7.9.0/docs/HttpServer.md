...
First of all, JSROOT scripts and files can be accessed via "jsrootsys/" path like "http://localhost:8080/jsrootsys/modules/core.js".
...
```javascript
import { httpRequest, draw } from './jsrootsys/modules/core.js';
