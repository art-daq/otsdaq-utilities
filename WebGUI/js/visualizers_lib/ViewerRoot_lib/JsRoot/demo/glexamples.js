examples_main = {
   TGeo : [
     ...
     { name: "overlap", asurl: true, file: "geom/overlap.root", item: "default/Overlaps/ov00010", itemfield: "Overlaps/ov00010",  title: "example of TGeoOverlap" },
       { name: "half", json: "geom/comp_half.json.gz", title: "Use of TGeoHalfSpace for building composites" },
       { name: "atlas_cryo", asurl: true, file: "https://root.cern/files/atlas.root", item: "atlas;1", opt: "macro:https://root.cern/files/atlas_c\
ryo.C" },
       ...
       { name: "Dipole", url: "?nobrowser&file=https://root.cern/files/alice2.root&item=Geometry;1/ALIC/Dipole_1", title: "Part of volumes from ge\
o manager" },
