...
# this script attempts to change the names in a downloaded repository, to be able to compile it with the otsdaq-demo.. check-in handling is not handled
#first run setup_ots.sh
# usage: ./ots_create_repo_from_demo.sh NAMEOFREPOSITORYFOLDER
#
