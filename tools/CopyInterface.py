...
print("***********************\n")
print(
    "Copying <Interface>.h and <Interface>_interface.cc and renaming...\n"
...
parser.add_argument("-o", "--old", required=True, help="Name of old Interface")
parser.add_argument("-d", "--dest", help="Destination path for new Interface")
parser.add_argument("-n", "--new", required=True, help="Name of new Interface")
...
os.system(
    "sed -i s/" + args.old + "/" + args.new + "/g " + dest + "/" + args.new + ".h"
)
