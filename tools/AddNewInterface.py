...
parser.add_argument("-s", "--src", help="Source path for new Interface")
parser.add_argument("-d", "--dest", help="Destination path for new Interface")
parser.add_argument("-n", "--name", help="Name of new Interface")
parser.add_argument("-hw", "--hardwareName", help="Name of new Interface")
parser.add_argument("-fw", "--firmwareName", help="Name of new Interface")
